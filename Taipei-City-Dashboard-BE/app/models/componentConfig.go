...
func createTempComponentDB() *gorm.DB {
	...
	selectColumns := []string{"id", "index", "name", "history_config", "map_filter", "time_from", "time_to", "update_freq", "update_freq_unit", "source", "short_desc", "long_desc", "use_case", "links", "contributors", "updated_at", "query_type", "tags"}
	selectString := ""
